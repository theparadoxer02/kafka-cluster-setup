LOG4J_ROOT_LOGLEVEL: This is apache log level parameter, can be passed to any apache confluent we are        running in docker mode just be adding the prefix of the service we want to run. 
